...
if(isset($_REQUEST["minus"]))
{
	...
	if($_SESSION["quantity"][$index]["quantity"]==1)
	{
...
{
		$_SESSION["quantity"][$_POST["index_of_q"]-1]["quantity"]++;
}
                    ...
                    if (isset($_SESSION['cart'])){
                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            foreach ($product_id as $id){
                                if ($row['id'] == $id){
                                    cartElement($row['image'], $row['name'],$row['price'],$quantity(), $row['id']);
                                    // $total = $total + (int)$row['price'];
                                    // $total=$total+($row["price"]*$_SESSION["quantity"][$key]["quantity"]);
                                    $key++;
                                }
                            }
                        }
