...
<div class="container">
  <h1 class="text-center text-danger mb-5" style="font-family: 'Abril Fatface',cursive;">Groceries</h1>
  <div class="row">
    <?php
    session_start();
    //$email=$_SESSION["login"]["email"];
  require_once("config.php");
  $sql='SELECT `id`,`name`, `image`, `quantity`, `price` FROM `products` WHERE type="packed"';
